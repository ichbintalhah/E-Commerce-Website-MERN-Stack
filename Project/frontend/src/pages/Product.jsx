      ...
      <div className="mt-20">
        ...
        <div className="flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500">
          <p>
            ...
            placeat laborum nulla dolor doloremque exercitationem adipisci
            libero omnis quaerat natus! Nemo, quos?
          </p>
          <p>
            Lorem ipsum, dolor sit amet consectetur adipisicing elit.
            Consequuntur corporis, quas veniam molestiae doloribus consectetur
            tenetur harum aspernatur a id, ratione omnis nesciunt.
          </p>
        </div>
      </div>
